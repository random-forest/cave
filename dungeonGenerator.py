...
class dungeonGenerator:
    ...
    def __init__(self, height, width):
        ...
        self.grid = [[EMPTY for i in range(self.height)]
    ...
    def findNeighbours(self, x, y):
        ...
        xi = (0, -1, 1) if 0 < x < self.width - \
            1 else ((0, -1) if x > 0 else (0, 1))
        yi = (0, -1, 1) if 0 < y < self.height - \
            1 else ((0, -1) if y > 0 else (0, 1))
        for a in xi:
            for b in yi:
                if a == b == 0:
                    continue
    ...
    def findUnconnectedAreas(self):
        ...
        unconnectedAreas = []
        areaCount = 0
        gridCopy = [[EMPTY for i in range(self.width)]
